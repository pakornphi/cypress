  ...
  it('create user test', () => {
    ...
    // ใช้ข้อมูลจากไฟล์ fixture เพื่อสร้างผู้ใช้
      ...
      cy.request({
        ...
        body: {
          "name": "khunkhun",
          "email": "helloworldkhun@cypress.io",
          "gender": "male",
          "status" : "active"
        }
      }).then((res) => {
        ...
        expect(res.body.data).to.have.property('email', "helloworldkhun@cypress.io")
        expect(res.body.data).to.have.property('name', "khunkhun")
        ...
        if (res && res.body && res.body.data) {
          ...
          cy.request({
            ...
            body: {
              "name": "khunkhunupdate",
              "email": "helloworldkhunupdate@cypress.io",
              "gender": "male",
              "status" : "inactive"
            }
          }).then((res) => {
            expect(res.status).to.eq(200)
            expect(res.body.data).to.have.property('email', 'helloworldkhunupdate@cypress.io')
            expect(res.body.data).to.have.property('name', 'khunkhunupdate')
            expect(res.body.data).to.have.property('gender',"male")
